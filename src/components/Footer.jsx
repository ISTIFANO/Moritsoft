        ...
        <footer className="bg-teal-700 text-white py-8">
            <div className="container mx-auto px-4 flex flex-wrap justify-between">
                <div className="w-full md:w-1/4 mb-6 md:mb-0 text-center md:text-left">
                    <img src="https://placehold.co/100x100" alt="Smart Influencer Logo" className="mx-auto md:mx-0 mb-4" />
                    <h2 className="text-xl font-semibold mb-2">Smart Influencer</h2>
                    <p className="text-sm">
                ...
                <div className="w-full md:w-1/4">
                    ...
                    <ul className="text-sm">
                        ...
                        <li className="flex items-center mb-2">
                            ...
                            <a href="mailto:info@smartinfluencer.ma" className="hover:underline">info@smartinfluencer.ma</a>
                        </li>
                        <li className="flex items-center mb-2">
                            <FontAwesomeIcon icon={faEnvelope} className="mr-2" />
                            <a href="mailto:direction@smartinfluencer.ma" className="hover:underline">direction@smartinfluencer.ma</a>
                        </li>
                        <li className="flex items-center mb-2">
            ...
            <div className="text-center mt-8 text-sm">
                © Copyright 2021. Smart Influencer By SEOCOM
            </div>
        </footer>
    )
}
